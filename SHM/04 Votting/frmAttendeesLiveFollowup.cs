...
namespace SHM
{
    public partial class frmAttendeesLiveFollowup : Form
    {
        ...
        public frmAttendeesLiveFollowup()
        {

            InitializeComponent();
        }

        private void frmAttendeesLiveFollowup_Load(object sender, EventArgs e)
        {

            this.MeetinRoundLabel.Text =  clUtility.GetMeetingRoundRoundNumber(1).ToString();
        ...
        private void frmAttendeesLiveFollowup_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void BindControls()
        {
            ...
            try
            {
                ...
                this._View_AttendeesSummaryLive = DataObj.GetDataTable("View_AttendeesSummaryLive");
        ...
        private void RefreshAttendeeInfo()
        {
            ...
            try
            {
                ...
                DataObj.OpenConnection();
                object result = DataObj.GetDataScalar("SELECT COUNT(*) FROM View_AttendeesSummaryLive");
                ...
                DataObj.FillData(this._View_AttendeesSummaryLive, "SELECT * FROM View_AttendeesSummaryLive ");
                if (_View_AttendeesSummaryLive.Rows.Count > 0)
                {
                    ...
                    if ((this._minPercentageReg - this._currentAtendeePercentage) <= 0)
                    {
